...
<div class="min-h-screen bg-indigo-900 flex justify-center items-center">
	...
	<div>
			<h1 class="text-3xl font-bold text-center mb-4 cursor-pointer">Ubah Data Supplier</h1>
		</div>
        ...
        <input type="text" placeholder="Input Jumlah Barang" name="jumlah" class="block text-sm py-3 px-4 rounded-lg w-full border outline-none <?php echo form_error('jumlah') ? 'is-invalid' : '' ?>" value="<?php echo $supplier->jumlah ?>" />

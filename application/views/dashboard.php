            ...
            <div class="flex w-full items-center justify-between">
                <nav x-transition :class="!navbarOpen && 'hidden'" id="navbarCollapse" class="absolute right-0 top-[90px] w-full max-w-[350px] rounded-lg border border-blue-200 bg-white py-5 px-6 shadow-lg shadow-blue-400/5 transition-all lg:static lg:block lg:max-w-full lg:border-none lg:shadow-none lg:bg-transparent lg:px-0 lg:py-0">
                    <ul class="flex flex-col justify-center gap-8 lg:flex-row">
                        <li>
                            <a href="#" class="text-lg font-medium text-slate-700 duration-200 hover:text-blue-600 lg:text-base">Home</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('barang')?>" class="text-lg font-medium text-slate-700 duration-200 hover:text-blue-600 lg:text-base">Barang</a>
                        </li>
                        <li>
    ...
    <div class="mx-auto max-w-7xl px-8 md:px-6">
        <div class="flex flex-wrap">
            <div class="w-full lg:w-5/12">
                <h1 class="text-slate-800 mb-3 text-4xl font-bold leading-snug sm:text-[42px] lg:text-[40px] xl:text-[42px]">Everything you need to run your online <span class="text-blue-600">business website</span></h1>
            ...
            <div class="w-full px-4 lg:w-6/12">
                <div class="lg:ml-auto lg:text-right">
                    <div class="relative z-10 inline-block pt-11 lg:pt-0">
                        <img src="https://media.discordapp.net/attachments/963226363362422794/1049189049463734282/hero.png?width=644&height=662" alt="hero section img" class="max-w-full lg:ml-auto">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mx-auto max-w-7xl px-8 md:px-6">
        ...
        <div class="md:flex md:justify-between md:gap-6 xl:gap-10">
            <div class="mb-5 max-h-[600px] overflow-hidden rounded-lg md:mb-0 md:w-5/12">
                <img src="https://media.discordapp.net/attachments/963226363362422794/1049189184646164530/features.png?width=521&height=663" alt="features img" class="h-full scale-125 sm:w-full sm:object-cover">
            </div>
            <div class="md:w-7/12">
                ...
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <div class="flex flex-col items-center justify-center rounded-xl bg-white px-4 py-8 shadow-lg">
                        <img class="mb-3 w-16" src="https://media.discordapp.net/attachments/963226363362422794/1049189236760391741/icon_1.png" alt="">
                        <h3 class="text-lg font-bold text-slate-600">Web Design</h3>
                        <a href="#" class="text-sm text-blue-500">Learn more</a>
                    </div>
                    <div class="flex flex-col items-center justify-center rounded-xl bg-white px-4 py-8 shadow-lg">
                        <img class="mb-3 w-16" src="https://media.discordapp.net/attachments/963226363362422794/1049189235950882896/icon_2.png" alt="">
                        <h3 class="text-lg font-bold text-slate-600">Automation</h3>
                        <a href="#" class="text-sm text-blue-500">Learn more</a>
                    </div>
                    <div class="flex flex-col items-center justify-center rounded-xl bg-white px-4 py-8 shadow-lg">
                        <img class="mb-3 w-16" src="https://media.discordapp.net/attachments/963226363362422794/1049189236353552445/icon_3.png" alt="">
        ...
        <div class="mb-5 sm:mb-10">
            ...
            <div class="md:flex md:justify-between md:gap-6">
                <div class="mb-8 flex justify-center md:mb-0 md:w-5/12">
                    <img src="https://media.discordapp.net/attachments/963226363362422794/1049190921289338910/faq.png?width=663&height=663" alt="faq images" class="max-h-[500px] md:max-h-max">
                </div>
        ...
        <div class="flex flex-col gap-5">
            ...
            <div class="grid gap-5 sm:grid-cols-2 md:grid-cols-4">
                <div class="group relative h-40 overflow-hidden rounded-lg lg:h-52">
                    <img src="https://media.discordapp.net/attachments/963226363362422794/1049191530621054996/image.png?width=1367&height=663" alt="portfolio img" class="absolute h-full w-full object-cover duration-200 group-hover:scale-125">
                    <div class="absolute -bottom-60 flex w-full cursor-pointer items-center justify-between bg-gradient-to-t from-slate-800 px-3 pb-4 pt-10 duration-200 group-hover:-bottom-0">
                        <p class="text-sm font-semibold text-white">Starbuck LandingPage UI<span class="text-xs text-slate-300 block">12 August 2022</span></p>
                        <ion-icon name="heart" class="rounded-full bg-white p-1.5 text-lg text-blue-500"></ion-icon>
                    </div>
                </div>
                <div class="group relative h-40 overflow-hidden rounded-lg lg:h-52">
                    <img src="https://media.discordapp.net/attachments/963226363362422794/1049195698081509396/Star_Ui.png?width=884&height=663" alt="portfolio img" class="absolute h-full w-full object-cover duration-200 group-hover:scale-125">
                    <div class="absolute -bottom-60 flex w-full cursor-pointer items-center justify-between bg-gradient-to-t from-slate-800 px-3 pb-4 pt-10 duration-200 group-hover:-bottom-0">
                        <p class="text-sm font-semibold text-white">Android "Kakiku" Project" UI<span class="text-xs text-slate-300 block">5 December 2022</span></p>
                        <ion-icon name="heart" class="rounded-full bg-white p-1.5 text-lg text-blue-500"></ion-icon>
                    </div>
                </div>
                <div class="group relative h-40 overflow-hidden rounded-lg lg:h-52 sm:col-span-2">
                    <img src="https://media.discordapp.net/attachments/963226363362422794/1049193709394202684/image.png?width=1367&height=663" alt="portfolio img" class="absolute h-full w-full object-cover duration-200 group-hover:scale-125">
                    <div class="absolute -bottom-60 flex w-full cursor-pointer items-center justify-between bg-gradient-to-t from-slate-800 px-3 pb-4 pt-10 duration-200 group-hover:-bottom-0">
                        <p class="text-sm font-semibold text-white">UML Presentation With Website UI<span class="text-xs text-slate-300 block">24 October 2022</span></p>
                        <ion-icon name="heart" class="rounded-full bg-white p-1.5 text-lg text-blue-500"></ion-icon>
                    </div>
                </div>
            </div>
            ...
            <div class="grid gap-5 sm:grid-cols-2 md:grid-cols-3">
                <div class="group relative h-40 overflow-hidden rounded-lg lg:h-52 md:col-span-2">
                    <img src="https://media.discordapp.net/attachments/963226363362422794/1049193709826220124/WhatsApp_Image_2022-12-05_at_13.18.17.jpg" alt="portfolio img" class="absolute h-full w-full object-cover duration-200 group-hover:scale-125">
                    <div class="absolute -bottom-60 flex w-full cursor-pointer items-center justify-between bg-gradient-to-t from-slate-800 px-3 pb-4 pt-10 duration-200 group-hover:-bottom-0">
                        <p class="text-sm font-semibold text-white">Admin Dashboard<span class="text-xs text-slate-300 block">2 August 2021</span></p>
                        <ion-icon name="heart" class="rounded-full bg-white p-1.5 text-lg text-blue-500"></ion-icon>
                    </div>
                </div>
                <div class="group relative h-40 overflow-hidden rounded-lg lg:h-52">
                    <img src="https://media.discordapp.net/attachments/963226363362422794/1049193710056914954/image.png?width=1367&height=663" alt="portfolio img" class="absolute h-full w-full object-cover duration-200 group-hover:scale-125">
                    <div class="absolute -bottom-60 flex w-full cursor-pointer items-center justify-between bg-gradient-to-t from-slate-800 px-3 pb-4 pt-10 duration-200 group-hover:-bottom-0">
                        <p class="text-sm font-semibold text-white">Tahura Project UI Design Website<span class="text-xs text-slate-300 block">12 December 2021</span></p>
                        <ion-icon name="heart" class="rounded-full bg-white p-1.5 text-lg text-blue-500"></ion-icon>
                    </div>
                </div>
            </div>
            ...
            <div class="grid gap-5 sm:grid-cols-2 md:grid-cols-4">
                <div class="group relative h-40 overflow-hidden rounded-lg lg:h-52">
                    <img src="https://media.discordapp.net/attachments/963226363362422794/1049356876455882772/William_Ui.png?width=895&height=671" alt="portfolio img" class="absolute h-full w-full object-cover duration-200 group-hover:scale-125">
                    <div class="absolute -bottom-60 flex w-full cursor-pointer items-center justify-between bg-gradient-to-t from-slate-800 px-3 pb-4 pt-10 duration-200 group-hover:-bottom-0">
                        <p class="text-sm font-semibold text-white">Android "Toko Wahyu" Project" UI<span class="text-xs text-slate-300 block">12 August 2025</span></p>
                        <ion-icon name="heart" class="rounded-full bg-white p-1.5 text-lg text-blue-500"></ion-icon>
                    </div>
                </div>
                <div class="group relative h-40 overflow-hidden rounded-lg lg:h-52">
                ...
                <div class="group relative h-40 overflow-hidden rounded-lg lg:h-52 sm:col-span-2">
                    <img src="https://media.discordapp.net/attachments/963226363362422794/1049196810817773619/WhatsApp_Image_2022-12-05_at_13.32.59.jpg" alt="portfolio img" class="absolute h-full w-full object-cover duration-200 group-hover:scale-125">
                    <div class="absolute -bottom-60 flex w-full cursor-pointer items-center justify-between bg-gradient-to-t from-slate-800 px-3 pb-4 pt-10 duration-200 group-hover:-bottom-0">
                        <p class="text-sm font-semibold text-white">Type Your portfolio details <span class="text-xs text-slate-300 block">12 August 2025</span></p>
                        <ion-icon name="heart" class="rounded-full bg-white p-1.5 text-lg text-blue-500"></ion-icon>
                    </div>
        ...
        <div class="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:gap-10">
            ...
            <div class="w-full duration-200 hover:scale-95">
                <div class="max-h-52 w-full overflow-hidden rounded-t-xl">
                    <img src="https://media.discordapp.net/attachments/963226363362422794/1049191530621054996/image.png?width=1367&height=663" alt="blog img" class="w-full">
                </div>
                <div class="rounded-b-xl px-5 pb-5 pt-3 shadow-md shadow-blue-500/10">
                    ...
                    <div class="flex">
                        <img src="https://media.discordapp.net/attachments/963226363362422794/1049358428860059648/user-3.png" alt="user img" class="mr-3 h-10 w-10 rounded-full object-cover">
            ...
            <div class="w-full duration-200 hover:scale-95">
                <div class="max-h-52 w-full overflow-hidden rounded-t-xl">
                    <img src="https://media.discordapp.net/attachments/963226363362422794/1049195698081509396/Star_Ui.png?width=884&height=663" alt="blog img" class="w-full">
                </div>
                <div class="rounded-b-xl px-5 pb-5 pt-3 shadow-md shadow-blue-500/10">
                    <div class="">
                        <a href="#" class="mr-2 rounded-md bg-blue-50 px-3 py-1 text-sm text-slate-600">Services</a>
                    ...
                    <hr class="my-4 border-slate-100">
                    <div class="flex">
                        <img src="https://media.discordapp.net/attachments/963226363362422794/1049358429170450503/user-1.png" alt="user img" class="mr-3 h-10 w-10 rounded-full object-cover">
                        <p class="text-sm font-semibold capitalize text-slate-600">Zahidul Hossain <span class="block text-xs text-slate-400">web designer</span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full duration-200 hover:scale-95">
                <div class="max-h-52 w-full overflow-hidden rounded-t-xl">
                    <img src="https://media.discordapp.net/attachments/963226363362422794/1049193710056914954/image.png?width=1367&height=663" alt="blog img" class="w-full">
                </div>
                <div class="rounded-b-xl px-5 pb-5 pt-3 shadow-md shadow-blue-500/10">
                    <div class="">
                    ...
                    <hr class="my-4 border-slate-100">
                    <div class="flex">
                        <img src="https://media.discordapp.net/attachments/963226363362422794/1049358429480820736/user-2.png" alt="user img" class="mr-3 h-10 w-10 rounded-full object-cover">
                        <p class="text-sm font-semibold capitalize text-slate-600">Zahidul Hossain <span class="block text-xs text-slate-400">web designer</span></p>
                    </div>
                </div>
            </div>
    ...
    <div class="mx-auto max-w-7xl px-8 md:px-6">
        ...
        <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
            <div class="md:max-w-md lg:col-span-2">
                <img src="https://media.discordapp.net/attachments/963226363362422794/1049180572884422736/teslogoh__1_-removebg-preview_1.png" alt="footer logo" class="w-36">
        ...
        <div class="flex flex-col justify-between border-t py-8 sm:flex-row">
            <p class="text-sm text-slate-500">© Copyright 2022 <a href="#" class="text-slate-700 hover:text-blue-500">BRJ</a> All rights reserved.</p>
